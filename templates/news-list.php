...
?>
<ul class="hpk-pp-news hpk-pp-news--list">
	<?php while ( $query->have_posts() ) : $query->the_post(); ?>
		...
		?>
		<li class="hpk-pp-news-item hpk-pp-news-item--<?php echo esc_attr( $type ); ?>">
			<?php if ( $show_image && has_post_thumbnail() ) : ?>
				<?php if ( $link ) : ?><a href="<?php echo esc_url( $link ); ?>" class="hpk-pp-news-thumb"><?php the_post_thumbnail( 'thumbnail' ); ?></a><?php else : ?><div class="hpk-pp-news-thumb"><?php the_post_thumbnail( 'thumbnail' ); ?></div><?php endif; ?>
			<?php endif; ?>
